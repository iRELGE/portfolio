...
type Role struct {
	...
	Role string `boil:"Role" json:"Role,omitempty" toml:"Role" yaml:"Role,omitempty"`
...
var (
	roleAllColumns            = []string{"ID", "Role"}
	roleColumnsWithoutDefault = []string{"Role"}
...
func (o *Role) UserRoles(mods ...qm.QueryMod) userRoleQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`user_roles`.`roles_id`=?", o.ID),
	)
...
func (roleL) LoadUserRoles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`user_roles`),
		qm.WhereIn(`user_roles.roles_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
